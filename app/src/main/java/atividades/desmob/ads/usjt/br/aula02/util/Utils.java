package atividades.desmob.ads.usjt.br.aula02.util;
...
public class Utils {
    ...
    private static atividades.desmob.ads.usjt.br.aula02.util.StatusTracker mStatusTracker =
            atividades.desmob.ads.usjt.br.aula02.util.StatusTracker.getInstance();
